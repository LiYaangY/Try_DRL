...
plane= pygame.image.load('E:/Postgraduate/Python/Practice/Avoid/pic/plane.jpg')
planeS = pygame.transform.smoothscale(plane, (WINDOW_WIDTH//4, WINDOW_HEIGHT//4))
BZ = pygame.image.load('E:/Postgraduate/Python/Practice/Avoid/pic/BZ.jpg')
...
hero_surface.append(BZS)
#砖头
ZT= pygame.image.load('E:/Postgraduate/Python/Practice/Avoid/pic/ZT.jpg')
